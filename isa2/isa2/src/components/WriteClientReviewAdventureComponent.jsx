...
class WriteClientReviewAdventureComponent extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    SubmitNegative(){
        ...
        axios.post("http://localhost:8080/api/v1/clientreviews/fishing_instructor",review)
...
export default WriteClientReviewAdventureComponent;