...
class CottageStatisticsComponent extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    componentDidMount() {
        ...
        if (activeUser.type != "cottage_owner") { this.logout(); alert("Unauthorised access") }
            ...
            axios.get("http://localhost:8080/api/v1/grades/typeandid/cottage_owner/cottage/" + activeCottage.id).then((res2) => {
...
export default CottageStatisticsComponent;