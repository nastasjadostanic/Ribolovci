...
class ShipAppointmentReservationComponent extends Component {
    constructor(props){
        super(props)
        this.state = {
            appointments: []
    ...
    toClient(id){
        ...
        .then(response => {
            ...
            this.props.history.push('/clientreviewshipreservation');});
    ...
    componentDidMount(){
        ...
        axios.get("http://localhost:8080/api/v1/shipappointments/ship/ship_owner/" + activeShip.id).then((res)=>{
...
export default ShipAppointmentReservationComponent;